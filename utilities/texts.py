...
🔴 درخواست شما لغو شد
درخواست : {sub_name}
به دلیل اشتباه بودن ایدی تلگرام یا دلیلی دیگر لفو شد
...
🔴 درخواست شما لغو شد
درخواست :{sub_name}
به دلیل اشتباه بودن پرداخت شما لفو شد
اگر فکر میکنی که اشتباه شده میتونی با ادمین ما در ارتباط باشی 👇
    """
    return text
...
✅ پرداخت شما تایید شد
درخواست :{sub_name}
پرداخت شما با موفقیت تایید شد و تلگرام پرمیوم شما به زودی برای شما فعال خواهد شد
"""
    return text
